...
const getWebpackConfig: GetWebpackConfig = (newConfig, type, overrides, nodeExternals, split, env, options) => {
  /** 入口 */
  ...
  // 添加 define plugin
  newConfig = AddDefinePlugin(newConfig, overrides, env === "development")
